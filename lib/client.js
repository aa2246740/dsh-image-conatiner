window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".VHwgdW_gallery{grid-template-columns:repeat(2,minmax(0,1fr));align-self:flex-start;gap:8px;width:min(100%,576px);margin-block:4px 8px;display:grid}.VHwgdW_gallery[data-count=\"1\"]{grid-template-columns:minmax(0,1fr)}.VHwgdW_gallery[data-count=\"3\"] .VHwgdW_asset:nth-child(3){grid-column:1/-1}.VHwgdW_gallery[data-count=\"3\"] .VHwgdW_asset:nth-child(3) .VHwgdW_tile,.VHwgdW_gallery[data-count=\"3\"] .VHwgdW_asset:nth-child(3) .VHwgdW_retry{aspect-ratio:2.04}.VHwgdW_gallery[data-compact=true]{grid-template-columns:repeat(3,minmax(0,1fr))}.VHwgdW_asset{min-width:0;min-height:0}.VHwgdW_tile,.VHwgdW_retry{aspect-ratio:1;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);width:100%;min-width:0;color:var(--dsw-alias-label-secondary);border-radius:14px;padding:0;display:grid;position:relative;overflow:hidden}.VHwgdW_gallery[data-count=\"1\"] .VHwgdW_tile,.VHwgdW_gallery[data-count=\"1\"] .VHwgdW_retry{aspect-ratio:var(--dic-ratio,1.3333);max-height:520px}.VHwgdW_tile{cursor:zoom-in;place-items:center}.VHwgdW_tile:disabled{cursor:wait}.VHwgdW_tile:focus-visible,.VHwgdW_retry:focus-visible,.VHwgdW_lightboxAction:focus-visible,.VHwgdW_nav:focus-visible,.VHwgdW_previewRetry:focus-visible,.VHwgdW_filmstripItem:focus-visible{outline:2px solid var(--dsw-alias-label-primary-bluish);outline-offset:2px}.VHwgdW_tile img{object-fit:cover;width:100%;height:100%;transition:transform var(--ds-transition-duration-fast,.16s) var(--ds-ease-in-out,ease);display:block}.VHwgdW_tile:hover img,.VHwgdW_tile:focus-visible img{transform:scale(1.015)}.VHwgdW_skeleton{background:var(--dsw-alias-bg-skeleton);animation:1.4s ease-in-out infinite alternate VHwgdW_pulse;position:absolute;inset:0}.VHwgdW_expand{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);width:32px;height:32px;color:var(--dsw-alias-label-primary);box-shadow:var(--dsw-shadow-lv2);opacity:0;transition:opacity var(--ds-transition-duration-fast,.16s) ease, transform var(--ds-transition-duration-fast,.16s) ease;border-radius:999px;place-items:center;display:grid;position:absolute;top:10px;right:10px;transform:translateY(-3px)}.VHwgdW_tile:hover .VHwgdW_expand,.VHwgdW_tile:focus-visible .VHwgdW_expand{opacity:1;transform:translateY(0)}.VHwgdW_retry{font:inherit;cursor:pointer;place-content:center;justify-items:center;gap:8px;font-size:13px;line-height:20px}.VHwgdW_retry:hover{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-label-primary)}.VHwgdW_lightbox{--dic-lightbox-control-bg:var(--dsw-alias-bg-overlay);--dic-lightbox-control-fg:var(--dsw-alias-label-primary);z-index:1000;place-items:center;padding:72px 96px 108px;display:grid;position:fixed;inset:0}.VHwgdW_mask{background:var(--dsw-alias-bg-mask-photo);position:absolute;inset:0}.VHwgdW_counter,.VHwgdW_actions,.VHwgdW_stage,.VHwgdW_nav,.VHwgdW_filmstrip{z-index:1;position:relative}.VHwgdW_counter{border:1px solid var(--dsw-alias-border-inverted2);background:var(--dic-lightbox-control-bg);min-width:58px;color:var(--dic-lightbox-control-fg);text-align:center;border-radius:999px;padding:7px 12px;font-size:13px;line-height:18px;position:fixed;top:22px;left:50%;transform:translate(-50%)}.VHwgdW_actions{gap:8px;display:flex;position:fixed;top:18px;right:20px}.VHwgdW_lightboxAction,.VHwgdW_nav{border:1px solid var(--dsw-alias-border-inverted2);background:var(--dic-lightbox-control-bg);color:var(--dic-lightbox-control-fg);box-shadow:var(--dsw-shadow-lv2);cursor:pointer;border-radius:999px;place-items:center;padding:0;display:grid}.VHwgdW_lightboxAction{width:40px;height:40px;text-decoration:none}.VHwgdW_lightboxAction:hover,.VHwgdW_nav:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.VHwgdW_stage{place-items:center;width:100%;min-width:0;height:100%;min-height:0;display:grid}.VHwgdW_preview{object-fit:contain;max-width:min(100%,1600px);max-height:calc(100vh - 180px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;display:block}.VHwgdW_previewStatus,.VHwgdW_previewRetry{border:1px solid var(--dsw-alias-border-inverted2);background:var(--dic-lightbox-control-bg);min-height:44px;color:var(--dic-lightbox-control-fg);font:inherit;border-radius:12px;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:20px;display:inline-flex}.VHwgdW_previewRetry{cursor:pointer}.VHwgdW_nav{width:46px;height:46px;position:fixed;top:50%;transform:translateY(-50%)}.VHwgdW_nav[data-direction=previous]{left:24px}.VHwgdW_nav[data-direction=next]{right:24px}.VHwgdW_filmstrip{border:1px solid var(--dsw-alias-border-inverted2);background:var(--dic-lightbox-control-bg);max-width:min(100vw - 48px,720px);box-shadow:var(--dsw-shadow-lv2);border-radius:14px;gap:8px;padding:8px;display:flex;position:fixed;bottom:18px;left:50%;overflow-x:auto;transform:translate(-50%)}.VHwgdW_filmstripItem{border:2px solid var(--dsw-alias-border-inverted2);background:var(--dsw-alias-bg-skeleton);cursor:pointer;opacity:.66;border-radius:10px;flex:none;place-items:center;width:52px;height:52px;padding:0;display:grid;overflow:hidden}.VHwgdW_filmstripItem[aria-current=true]{border-color:var(--dic-lightbox-control-fg);opacity:1}.VHwgdW_filmstripItem img,.VHwgdW_filmstripItem span{object-fit:cover;width:100%;height:100%;display:block}.VHwgdW_filmstripItem span[data-state=error]{background:var(--dsw-alias-interactive-bg-hover-danger)}.VHwgdW_srOnly{clip:rect(0, 0, 0, 0);white-space:nowrap;border:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}@keyframes VHwgdW_pulse{0%{opacity:.5}to{opacity:1}}@media (width<=720px){.VHwgdW_gallery[data-compact=true]{grid-template-columns:repeat(2,minmax(0,1fr))}.VHwgdW_lightbox{padding:68px 18px 104px}.VHwgdW_preview{max-height:calc(100vh - 172px)}.VHwgdW_nav{width:40px;height:40px;top:auto;bottom:22px;transform:none}.VHwgdW_nav[data-direction=previous]{left:16px}.VHwgdW_nav[data-direction=next]{right:16px}.VHwgdW_filmstrip{max-width:calc(100vw - 144px)}}@media (hover:none),(pointer:coarse){.VHwgdW_expand{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.VHwgdW_tile img,.VHwgdW_expand{transition:none}.VHwgdW_skeleton{animation:none}}";
		...
		var ImageContainer_module_css_default = {
			"actions": "VHwgdW_actions",
			"asset": "VHwgdW_asset",
			"counter": "VHwgdW_counter",
			"expand": "VHwgdW_expand",
			"filmstrip": "VHwgdW_filmstrip",
			"filmstripItem": "VHwgdW_filmstripItem",
			"gallery": "VHwgdW_gallery",
			"lightbox": "VHwgdW_lightbox",
			"lightboxAction": "VHwgdW_lightboxAction",
			"mask": "VHwgdW_mask",
			"nav": "VHwgdW_nav",
			"preview": "VHwgdW_preview",
			"previewRetry": "VHwgdW_previewRetry",
			"previewStatus": "VHwgdW_previewStatus",
			"pulse": "VHwgdW_pulse",
			"retry": "VHwgdW_retry",
			"skeleton": "VHwgdW_skeleton",
			"srOnly": "VHwgdW_srOnly",
			"stage": "VHwgdW_stage",
			"tile": "VHwgdW_tile"
		};
		//#endregion
		...
		function ImageContainer({ images, loadImage, t }) {
			const items = (0, react.useMemo)(() => images.map((image, index) => "attachment" in image ? {
