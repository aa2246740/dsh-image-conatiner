window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dshx-css-module:/Users/wu/Documents/Codex/2026-08-15/bang/deepseek-harness-rc8/my-plugins/dsh-image-conatiner/src/client/ImageContainer.module.css.mjs
		const css = ".UjVVHa_gallery{grid-template-columns:repeat(2,minmax(0,1fr));align-self:flex-start;gap:8px;width:min(100%,576px);margin-block:4px 8px;display:grid}.UjVVHa_gallery[data-count=\"1\"]{grid-template-columns:minmax(0,1fr)}.UjVVHa_gallery[data-count=\"3\"] .UjVVHa_asset:nth-child(3){grid-column:1/-1}.UjVVHa_gallery[data-count=\"3\"] .UjVVHa_asset:nth-child(3) .UjVVHa_tile,.UjVVHa_gallery[data-count=\"3\"] .UjVVHa_asset:nth-child(3) .UjVVHa_retry{aspect-ratio:2.04}.UjVVHa_gallery[data-compact=true]{grid-template-columns:repeat(3,minmax(0,1fr))}.UjVVHa_asset{min-width:0;min-height:0}.UjVVHa_tile,.UjVVHa_retry{aspect-ratio:1;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);width:100%;min-width:0;color:var(--dsw-alias-label-secondary);border-radius:14px;padding:0;display:grid;position:relative;overflow:hidden}.UjVVHa_gallery[data-count=\"1\"] .UjVVHa_tile,.UjVVHa_gallery[data-count=\"1\"] .UjVVHa_retry{aspect-ratio:var(--dic-ratio,1.3333);max-height:520px}.UjVVHa_tile{cursor:zoom-in;place-items:center}.UjVVHa_tile:disabled{cursor:wait}.UjVVHa_tile:focus-visible,.UjVVHa_retry:focus-visible,.UjVVHa_lightboxAction:focus-visible,.UjVVHa_nav:focus-visible,.UjVVHa_previewRetry:focus-visible,.UjVVHa_filmstripItem:focus-visible{outline:2px solid var(--dsw-alias-label-primary-bluish);outline-offset:2px}.UjVVHa_tile img{object-fit:cover;width:100%;height:100%;transition:transform var(--ds-transition-duration-fast,.16s) var(--ds-ease-in-out,ease);display:block}.UjVVHa_tile:hover img,.UjVVHa_tile:focus-visible img{transform:scale(1.015)}.UjVVHa_skeleton{background:var(--dsw-alias-bg-skeleton);animation:1.4s ease-in-out infinite alternate UjVVHa_pulse;position:absolute;inset:0}.UjVVHa_expand{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);width:32px;height:32px;color:var(--dsw-alias-label-primary);box-shadow:var(--dsw-shadow-lv2);opacity:0;transition:opacity var(--ds-transition-duration-fast,.16s) ease, transform var(--ds-transition-duration-fast,.16s) ease;border-radius:999px;place-items:center;display:grid;position:absolute;top:10px;right:10px;transform:translateY(-3px)}.UjVVHa_tile:hover .UjVVHa_expand,.UjVVHa_tile:focus-visible .UjVVHa_expand{opacity:1;transform:translateY(0)}.UjVVHa_retry{font:inherit;cursor:pointer;place-content:center;justify-items:center;gap:8px;font-size:13px;line-height:20px}.UjVVHa_retry:hover{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-label-primary)}.UjVVHa_lightbox{--dic-lightbox-control-bg:var(--dsw-alias-bg-overlay);--dic-lightbox-control-fg:var(--dsw-alias-label-primary);z-index:1000;place-items:center;padding:72px 96px 108px;display:grid;position:fixed;inset:0}.UjVVHa_mask{background:var(--dsw-alias-bg-mask-photo);position:absolute;inset:0}.UjVVHa_counter,.UjVVHa_actions,.UjVVHa_stage,.UjVVHa_nav,.UjVVHa_filmstrip{z-index:1;position:relative}.UjVVHa_counter{border:1px solid var(--dsw-alias-border-inverted2);background:var(--dic-lightbox-control-bg);min-width:58px;color:var(--dic-lightbox-control-fg);text-align:center;border-radius:999px;padding:7px 12px;font-size:13px;line-height:18px;position:fixed;top:22px;left:50%;transform:translate(-50%)}.UjVVHa_actions{gap:8px;display:flex;position:fixed;top:18px;right:20px}.UjVVHa_lightboxAction,.UjVVHa_nav{border:1px solid var(--dsw-alias-border-inverted2);background:var(--dic-lightbox-control-bg);color:var(--dic-lightbox-control-fg);box-shadow:var(--dsw-shadow-lv2);cursor:pointer;border-radius:999px;place-items:center;padding:0;display:grid}.UjVVHa_lightboxAction{width:40px;height:40px;text-decoration:none}.UjVVHa_lightboxAction:hover,.UjVVHa_nav:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.UjVVHa_stage{place-items:center;width:100%;min-width:0;height:100%;min-height:0;display:grid}.UjVVHa_preview{object-fit:contain;max-width:min(100%,1600px);max-height:calc(100vh - 180px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;display:block}.UjVVHa_previewStatus,.UjVVHa_previewRetry{border:1px solid var(--dsw-alias-border-inverted2);background:var(--dic-lightbox-control-bg);min-height:44px;color:var(--dic-lightbox-control-fg);font:inherit;border-radius:12px;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:20px;display:inline-flex}.UjVVHa_previewRetry{cursor:pointer}.UjVVHa_nav{width:46px;height:46px;position:fixed;top:50%;transform:translateY(-50%)}.UjVVHa_nav[data-direction=previous]{left:24px}.UjVVHa_nav[data-direction=next]{right:24px}.UjVVHa_filmstrip{border:1px solid var(--dsw-alias-border-inverted2);background:var(--dic-lightbox-control-bg);max-width:min(100vw - 48px,720px);box-shadow:var(--dsw-shadow-lv2);border-radius:14px;gap:8px;padding:8px;display:flex;position:fixed;bottom:18px;left:50%;overflow-x:auto;transform:translate(-50%)}.UjVVHa_filmstripItem{border:2px solid var(--dsw-alias-border-inverted2);background:var(--dsw-alias-bg-skeleton);cursor:pointer;opacity:.66;border-radius:10px;flex:none;place-items:center;width:52px;height:52px;padding:0;display:grid;overflow:hidden}.UjVVHa_filmstripItem[aria-current=true]{border-color:var(--dic-lightbox-control-fg);opacity:1}.UjVVHa_filmstripItem img,.UjVVHa_filmstripItem span{object-fit:cover;width:100%;height:100%;display:block}.UjVVHa_filmstripItem span[data-state=error]{background:var(--dsw-alias-interactive-bg-hover-danger)}.UjVVHa_srOnly{clip:rect(0, 0, 0, 0);white-space:nowrap;border:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}@keyframes UjVVHa_pulse{0%{opacity:.5}to{opacity:1}}@media (width<=720px){.UjVVHa_gallery[data-compact=true]{grid-template-columns:repeat(2,minmax(0,1fr))}.UjVVHa_lightbox{padding:68px 18px 104px}.UjVVHa_preview{max-height:calc(100vh - 172px)}.UjVVHa_nav{width:40px;height:40px;top:auto;bottom:22px;transform:none}.UjVVHa_nav[data-direction=previous]{left:16px}.UjVVHa_nav[data-direction=next]{right:16px}.UjVVHa_filmstrip{max-width:calc(100vw - 144px)}}@media (hover:none),(pointer:coarse){.UjVVHa_expand{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.UjVVHa_tile img,.UjVVHa_expand{transition:none}.UjVVHa_skeleton{animation:none}}";
		...
		var ImageContainer_module_css_default = {
			"actions": "UjVVHa_actions",
			"asset": "UjVVHa_asset",
			"counter": "UjVVHa_counter",
			"expand": "UjVVHa_expand",
			"filmstrip": "UjVVHa_filmstrip",
			"filmstripItem": "UjVVHa_filmstripItem",
			"gallery": "UjVVHa_gallery",
			"lightbox": "UjVVHa_lightbox",
			"lightboxAction": "UjVVHa_lightboxAction",
			"mask": "UjVVHa_mask",
			"nav": "UjVVHa_nav",
			"preview": "UjVVHa_preview",
			"previewRetry": "UjVVHa_previewRetry",
			"previewStatus": "UjVVHa_previewStatus",
			"pulse": "UjVVHa_pulse",
			"retry": "UjVVHa_retry",
			"skeleton": "UjVVHa_skeleton",
			"srOnly": "UjVVHa_srOnly",
			"stage": "UjVVHa_stage",
			"tile": "UjVVHa_tile"
		};
		//#endregion
		...
		function ImageContainer({ images, loadImage, t }) {
			const items = (0, react.useMemo)(() => images.map(({ attachment }, index) => ({
